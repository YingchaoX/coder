---
name: create-skill
description: Guides users through creating effective Agent Skills for coder. Use when the user wants to create, write, or author a new skill, or asks about skill structure, best practices, or SKILL.md format.
---
# Creating Skills in coder

This skill guides you through creating effective Agent Skills for coder. Skills are markdown files that teach the agent how to perform specific tasks: reviewing PRs using team standards, generating commit messages in a preferred format, querying database schemas, or any specialized workflow.
...
2. **Target location**: Should this be a personal skill (~/.coder/skills/) or project skill (.coder/skills/)?
...
- "Where should this skill be stored?" with options like ["Personal (~/.coder/skills/)", "Project (.coder/skills/)"]
...
| Type | Path | Scope |
|------|------|-------|
| Personal | ~/.coder/skills/skill-name/ | Available across all your projects |
| Project | .coder/skills/skill-name/ | Shared with anyone using the repository |

**IMPORTANT**: Skills are loaded from `skills.paths` in config. Create skills only in `~/.coder/skills/` (personal) or `.coder/skills/` (project). Do not create under application or read-only directories.
